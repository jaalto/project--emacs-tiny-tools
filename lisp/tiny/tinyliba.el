...
;; Copyright (C)    1998-2024 Jari Aalto
;; Keywords:        extensions
;; Author:          Jari Aalto
...
;;; ..  ..  ..  ..  ..  ..  ..  ..  ..  ..  ..  ..  ..  .. Emacs 19.30  ..
  ...
  (when nil
    ...
    (autoload 'cl-fill                              "cl" "" nil)
    (autoload 'cl-replace                           "cl-seq" "" nil)
    (autoload 'cl-remove                            "cl" "" nil)
    ...
    (autoload 'remq                                 "subr" "" nil)
    (autoload 'cl-remove-duplicates                 "cl" "" nil)
    (autoload 'cl-delete-duplicates                 "cl" "" nil)
    (autoload 'cl-substitute                        "cl" "" nil)
    (autoload 'cl-substitute-if                     "cl" "" nil)
    (autoload 'cl-substitute-if-not                 "cl-seq" "" nil)
    (autoload 'cl-nsubstitute                       "cl" "" nil)
    (autoload 'cl-nsubstitute-if                    "cl-seq" "" nil)
    (autoload 'cl-nsubstitute-if-not                "cl-seq" "" nil)
    (autoload 'cl-find                              "cl" "" nil)
